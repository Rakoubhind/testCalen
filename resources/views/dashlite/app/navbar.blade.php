                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item">
                                <a href="/addAppointment" class="nk-menu-link"><span class="nk-menu-text"><em class="icon ni ni-plus mr-2"></em>Créer un rendez vous</span></a>
                            </li>
                            <li class="nk-menu-item">
                                <a href="/appointment" class="nk-menu-link"><span class="nk-menu-text"><em class="icon ni ni-eye mr-2"></em>Voir les rendez vous</span></a>
                            </li>
                            <li class="nk-menu-item">
                                <a href="/ckeditor" class="nk-menu-link"><em class="icon ni ni-calendar mr-2"></em><span class="nk-menu-text">Calendar</span></a>
                            </li>
                        </ul><!-- .nk-menu-sub -->
                    </li><!-- .nk-menu-item -->
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item has-sub">
                                <a href="/agents" class="nk-menu-link ">
                            ...
                            <li class="nk-menu-item has-sub">
                                <a href="#" class="nk-menu-link nk-menu-toggle">
                                    <span class="nk-menu-text">Equipe</span>
                                </a>
                                <ul class="nk-menu-sub">
                                    <li class="nk-menu-item">
                            ...
                            <li class="nk-menu-item has-sub">
                                ...
                                <ul class="nk-menu-sub">
                                    <li class="nk-menu-item">
                                        <a href="/configfiscale" class="nk-menu-link"><span class="nk-menu-text">Configurer</span></a>
                                    </li>
